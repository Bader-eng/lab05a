...
function sumArray(sumArr) { //eslint-disable-line
    sumArr=[]
    let sumArr1
    sumArr1=sum(testArray[0],testArray[1])[0];
    let sumArr2
    sumArr2 =sumArr1+testArray[2]
    console.log(sumArr2)
    sumArr[0]=sumArr2
    sumArr[1]='2,3,4 was passed in as an array of numbers, and 9 is their sum.'
    console.log(sumArr)
    return sumArr
}
sumArray(testArray)
...
finished, uncomment the call for the testMultiplyArray() function and see if the test passes.*/

// Write your code here
function multiplyArray(multArr) { //eslint-disable-line
    multArr=[]
    let multiplya
    multiplya=multiply(testArray[0],testArray[1])[0];
    let multiplyb
    multiplyb=multiplya*testArray[2]
    console.log(multiplyb)
    multArr[0]=multiplyb
    multArr[1]='The numbers 2,3,4 have a product of 24.'
    console.log(multArr)
    return multArr
}
